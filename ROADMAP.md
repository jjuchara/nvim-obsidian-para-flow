...
- [x] Node 1: repository skeleton, development tools, isolated tests, and CI.
- [x] Node 2: validated public configuration, API, commands, and mappings.
...
- [ ] Node 5: Inbox domain model and metadata rules.
