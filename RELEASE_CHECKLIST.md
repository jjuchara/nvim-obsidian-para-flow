...
- [x] The project owner explicitly authorized `v0.15.0` publication while the focused Metadata-menu
  ...
  complete.
- [x] Release commit `ba2b812a8c7bb1bffdaca7b8222d8c9d31655d2a`, annotated tag, and the
  public GitHub Release `v0.15.0` are published; tag/main GitHub Actions runs `30815698314` and
  `30815697608` pass on Neovim 0.10–0.12. ✅ 2026-08-03
...
- [x] The `v0.14.0` linked-completion and current-note date-property release candidate passes
  ...
  Vim help generation, and `git diff --check`. The paired `obsidian-tasks.nvim v0.12.0` headless,
  formatting, help-tag, and diff gates also pass.
- [x] The project owner explicitly authorized `v0.14.0` publication while the focused linked-task
  completion and current-note date-property disposable-vault scenarios remain open; this release
  does not mark that evidence complete.
- [x] GitHub Actions tag/main runs `30813666138` and `30813666769` pass for commit
  `5e44d683832bae475c4f2d01b5d566c543091462` on Neovim 0.10–0.12; annotated tag and public,
  non-prerelease GitHub Release `v0.14.0` resolve to the same code. ✅ 2026-08-03
...
- [x] GitHub Actions tag/main runs `30663109178` and `30663109155` pass for commit
  `76e09958d4b3aabcc87a4ce4d5f3c47b60a0029a` on Neovim 0.10–0.12; annotated tag and public,
  non-prerelease GitHub Release `v0.13.0` resolve to the same code. ✅ 2026-07-31
...
The `v0.13.0` release adds indexed tag discovery and native `tag:#name` search through the official
Obsidian CLI, exposed by `<leader>oft`, `:ObsidianParaTags`, and `tags()`. Release commit
`76e09958d4b3aabcc87a4ce4d5f3c47b60a0029a`, annotated tag, remote release ref, and the public
GitHub Release resolve to the same code; tag/main CI runs `30663109178` and `30663109155` are green
on Neovim 0.10–0.12. The focused disposable-vault tag-search evidence remains open by explicit
owner authorization.
